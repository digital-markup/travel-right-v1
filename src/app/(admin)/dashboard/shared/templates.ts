...
const BASE_TEMPLATE = `You are an enthusiastic AI assistant. Greet them nicely if they greet you. Use the following pieces of context to answer the question at the end.
